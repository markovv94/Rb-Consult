    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <nav class="flex items-center space-x-2 text-sm text-gray-400">
                ...
                <span class="text-gray-200">Datenschutzerklärung</span>
            </nav>
        </div>
        <h1 class="text-5xl lg:text-6xl font-display font-bold text-white leading-tight">Datenschutzerklärung</h1>
    </div>
</section>
